...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 149624703;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiAppNodeConnectPeer({
    required AppNode that,
  ...
  Future<void> crateApiAppNodeDisconnectRelay({required AppNode that});
  ...
  Future<String?> crateApiAppNodeGetInvitePayload({
    required AppNode that,
    required String groupId,
    required String festivalId,
  });
  ...
  Future<int> crateApiAppNodeGetPeerCount({required AppNode that});

  Future<List<PeerStatusInfo>> crateApiAppNodeGetPeerList({
    required AppNode that,
  });
  ...
  Future<void> crateApiAppNodeLogoutPreservingPublicData({
    required AppNode that,
  });

  Future<MeshtasticDebugReportDto>
  crateApiAppNodeMeshtasticListenApplyGroupChats({
    required AppNode that,
    required String deviceId,
    required String festivalId,
  ...
  Future<MeshtasticDebugReportDto> crateApiAppNodeMeshtasticSendGroupChat({
    required AppNode that,
    required String deviceId,
    required String groupId,
  ...
  Future<bool> crateApiAppNodeReplaceFestivalRegistryCache({
    required AppNode that,
  ...
  Future<void> crateApiAppNodeRestartBle({required AppNode that});
  ...
  Future<void> crateApiAppNodeStartBleSync({required AppNode that});

  Future<void> crateApiAppNodeStopBleSync({required AppNode that});
  ...
  Future<void> crateApiAppNodeSubscribeGroups({
    required AppNode that,
    required String festivalId,
  });
  ...
  Future<String> crateApiAppNodeUnlockIdentityFromPrf({
    required AppNode that,
    required List<int> prfOutput,
  });
  ...
  Future<Stream<List<PeerStatusInfo>>> crateApiAppNodeWatchPeerList({
    required AppNode that,
  });
  ...
  Future<FestivalRegistryCacheDto?> crateApiFestivalRegistryCacheStoreLoad({
    required FestivalRegistryCacheStore that,
  });

  Future<FestivalRegistryCacheStore> crateApiFestivalRegistryCacheStoreOpen({
    required String dbPath,
  });

  Future<bool> crateApiFestivalRegistryCacheStoreReplace({
    required FestivalRegistryCacheStore that,
    required String payloadJson,
    required String fetchedAt,
    required String requestToken,
  ...
  Future<SyncStatusDto> crateApiDtoConvertSyncStatus({
    required SyncStatus status,
  });

  Future<Uint8List> crateApiDtoGenerateGroupKey();
  ...
  Future<LineupDto?> crateApiDtoReadLineupFromDoc({
    required DocManager dm,
    required String docId,
  });

  Future<WeatherForecastDto?> crateApiDtoReadWeatherFromDoc({
    required DocManager dm,
    required String docId,
  });

  Future<TransportStatusDto> crateApiDtoSnapshotTransport({
    required OffbeatNode node,
  });
  ...
  get rust_arc_increment_strong_count_DocManager;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_DocManager;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_DocManagerPtr;

  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_FestivalRegistryCacheStore;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_FestivalRegistryCacheStore;

  CrossPlatformFinalizerArg
  get rust_arc_decrement_strong_count_FestivalRegistryCacheStorePtr;

  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_OffbeatNode;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_OffbeatNode;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_OffbeatNodePtr;

  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_PeerEntry;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_PeerEntry;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_PeerEntryPtr;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiAppNodeConnectPeer({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeConnectPeerConstMeta,
  ...
  TaskConstMeta get kCrateApiAppNodeConnectPeerConstMeta => const TaskConstMeta(
    debugName: "AppNode_connect_peer",
  ...
  Future<void> crateApiAppNodeDisconnectRelay({required AppNode that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeDisconnectRelayConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeDisconnectRelayConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_disconnect_relay",
        argNames: ["that"],
      );
  ...
  Future<FestivalRegistryCacheDto?> crateApiAppNodeGetFestivalRegistryCache({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeGetFestivalRegistryCacheConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeGetFestivalRegistryCacheConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_get_festival_registry_cache",
        argNames: ["that"],
      );
  ...
  Future<String?> crateApiAppNodeGetInvitePayload({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeGetInvitePayloadConstMeta,
        argValues: [that, groupId, festivalId],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiAppNodeGetInvitePayloadConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_get_invite_payload",
        argNames: ["that", "groupId", "festivalId"],
      );
  ...
  Future<int> crateApiAppNodeGetPeerCount({required AppNode that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeGetPeerCountConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeGetPeerCountConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_get_peer_count",
        argNames: ["that"],
      );
  ...
  Future<List<PeerStatusInfo>> crateApiAppNodeGetPeerList({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeGetPeerListConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeGetPeerListConstMeta => const TaskConstMeta(
    debugName: "AppNode_get_peer_list",
    argNames: ["that"],
  );
  ...
  Future<GroupJoinResultDto> crateApiAppNodeJoinGroup({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        argValues: [that, invitePayload, festivalId, displayName],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta get kCrateApiAppNodeJoinGroupConstMeta => const TaskConstMeta(
    ...
    argNames: ["that", "invitePayload", "festivalId", "displayName"],
  );
  ...
  Future<void> crateApiAppNodeLogoutPreservingPublicData({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeLogoutPreservingPublicDataConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeLogoutPreservingPublicDataConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_logout_preserving_public_data",
        argNames: ["that"],
      );
  ...
  crateApiAppNodeMeshtasticListenApplyGroupChats({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeMeshtasticListenApplyGroupChatsConstMeta,
        argValues: [that, deviceId, festivalId, listenMs],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiAppNodeMeshtasticListenApplyGroupChatsConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_meshtastic_listen_apply_group_chats",
        argNames: ["that", "deviceId", "festivalId", "listenMs"],
      );
  ...
  Future<MeshtasticDebugReportDto> crateApiAppNodeMeshtasticSendGroupChat({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeMeshtasticSendGroupChatConstMeta,
        argValues: [that, deviceId, groupId, text],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiAppNodeMeshtasticSendGroupChatConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_meshtastic_send_group_chat",
        argNames: ["that", "deviceId", "groupId", "text"],
      );
  ...
  Future<void> crateApiAppNodeNudgeGossip({required AppNode that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeNudgeGossipConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeNudgeGossipConstMeta => const TaskConstMeta(
    debugName: "AppNode_nudge_gossip",
    argNames: ["that"],
  );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(fetchedAt, serializer);
          sse_encode_String(requestToken, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 36,
        ...
        constMeta: kCrateApiAppNodeReplaceFestivalRegistryCacheConstMeta,
        argValues: [that, payloadJson, fetchedAt, requestToken],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiAppNodeReplaceFestivalRegistryCacheConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_replace_festival_registry_cache",
        argNames: ["that", "payloadJson", "fetchedAt", "requestToken"],
      );
  ...
  Future<void> crateApiAppNodeRestartBle({required AppNode that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeRestartBleConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeRestartBleConstMeta =>
      const TaskConstMeta(debugName: "AppNode_restart_ble", argNames: ["that"]);
  ...
  Future<void> crateApiAppNodeStartBleSync({required AppNode that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeStartBleSyncConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeStartBleSyncConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_start_ble_sync",
        argNames: ["that"],
      );
  ...
  Future<void> crateApiAppNodeStopBleSync({required AppNode that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeStopBleSyncConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeStopBleSyncConstMeta => const TaskConstMeta(
    debugName: "AppNode_stop_ble_sync",
    argNames: ["that"],
  );
  ...
  Future<void> crateApiAppNodeSubscribeGroups({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeSubscribeGroupsConstMeta,
        argValues: [that, festivalId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeSubscribeGroupsConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_subscribe_groups",
        argNames: ["that", "festivalId"],
      );
  ...
  Future<String> crateApiAppNodeUnlockIdentityFromPrf({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAppNodeUnlockIdentityFromPrfConstMeta,
        argValues: [that, prfOutput],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeUnlockIdentityFromPrfConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_unlock_identity_from_prf",
        argNames: ["that", "prfOutput"],
      );
  ...
  Future<Stream<List<PeerStatusInfo>>> crateApiAppNodeWatchPeerList({
    ...
    final sink = RustStreamSink<List<PeerStatusInfo>>();
    await handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          ...
          sse_encode_StreamSink_list_peer_status_info_Sse(sink, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 57,
        ...
        constMeta: kCrateApiAppNodeWatchPeerListConstMeta,
        argValues: [that, sink],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAppNodeWatchPeerListConstMeta =>
      const TaskConstMeta(
        debugName: "AppNode_watch_peer_list",
        argNames: ["that", "sink"],
      );
  ...
  Future<FestivalRegistryCacheDto?> crateApiFestivalRegistryCacheStoreLoad({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFestivalRegistryCacheStoreLoadConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFestivalRegistryCacheStoreLoadConstMeta =>
      const TaskConstMeta(
        debugName: "FestivalRegistryCacheStore_load",
        argNames: ["that"],
      );
  ...
  Future<FestivalRegistryCacheStore> crateApiFestivalRegistryCacheStoreOpen({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFestivalRegistryCacheStoreOpenConstMeta,
        argValues: [dbPath],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFestivalRegistryCacheStoreOpenConstMeta =>
      const TaskConstMeta(
        debugName: "FestivalRegistryCacheStore_open",
        argNames: ["dbPath"],
      );
  ...
  Future<bool> crateApiFestivalRegistryCacheStoreReplace({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFestivalRegistryCacheStoreReplaceConstMeta,
        argValues: [that, payloadJson, fetchedAt, requestToken],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFestivalRegistryCacheStoreReplaceConstMeta =>
      const TaskConstMeta(
        debugName: "FestivalRegistryCacheStore_replace",
        argNames: ["that", "payloadJson", "fetchedAt", "requestToken"],
      );
  ...
  Future<SyncStatusDto> crateApiDtoConvertSyncStatus({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiDtoConvertSyncStatusConstMeta,
        argValues: [status],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDtoConvertSyncStatusConstMeta =>
      const TaskConstMeta(
        debugName: "convert_sync_status",
        argNames: ["status"],
      );
  ...
  Future<Uint8List> crateApiDtoGenerateGroupKey() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiDtoGenerateGroupKeyConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDtoGenerateGroupKeyConstMeta =>
  ...
  Future<String> crateApiDtoGroupIdFromKey({required List<int> key}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiDtoGroupIdFromKeyConstMeta,
        argValues: [key],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDtoGroupIdFromKeyConstMeta =>
  ...
  Future<PeerStatusInfo> crateApiDtoPeerEntryToDto({required PeerEntry entry}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_peer_status_info,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiDtoPeerEntryToDtoConstMeta,
        argValues: [entry],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDtoPeerEntryToDtoConstMeta =>
      const TaskConstMeta(debugName: "peer_entry_to_dto", argNames: ["entry"]);
  ...
  Future<LineupDto?> crateApiDtoReadLineupFromDoc({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiDtoReadLineupFromDocConstMeta,
        argValues: [dm, docId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDtoReadLineupFromDocConstMeta =>
      const TaskConstMeta(
        debugName: "read_lineup_from_doc",
        argNames: ["dm", "docId"],
      );
  ...
  Future<WeatherForecastDto?> crateApiDtoReadWeatherFromDoc({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiDtoReadWeatherFromDocConstMeta,
        argValues: [dm, docId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDtoReadWeatherFromDocConstMeta =>
      const TaskConstMeta(
        debugName: "read_weather_from_doc",
        argNames: ["dm", "docId"],
      );
  ...
  Future<TransportStatusDto> crateApiDtoSnapshotTransport({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiDtoSnapshotTransportConstMeta,
        argValues: [node],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDtoSnapshotTransportConstMeta =>
      const TaskConstMeta(debugName: "snapshot_transport", argNames: ["node"]);
  ...
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFestivalRegistryCacheStore(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return FestivalRegistryCacheStoreImpl.frbInternalDcoDecode(
      raw as List<dynamic>,
    );
  }
  ...
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPeerEntry(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return PeerEntryImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerDocManager(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return DocManagerImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerOffbeatNode(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return OffbeatNodeImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  ArtistProfileDto dco_decode_artist_profile_dto(dynamic raw) {
    ...
    return ArtistProfileDto(
      ...
      mbid: dco_decode_opt_String(arr[2]),
      ...
      relations: dco_decode_list_artist_relation_dto(arr[10]),
  ...
  ArtistRelationDto dco_decode_artist_relation_dto(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return ArtistRelationDto(
      kind: dco_decode_String(arr[0]),
      artistId: dco_decode_String(arr[1]),
    );
  }
  ...
  BleStatusDto dco_decode_ble_status_dto(dynamic raw) {
    ...
    return BleStatusDto(
      ...
      advertisingBeacons: dco_decode_list_String(arr[6]),
    );
  }
  ...
  FestivalRegistryCacheDto dco_decode_box_autoadd_festival_registry_cache_dto(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_festival_registry_cache_dto(raw);
  }
  ...
  FestivalRegistryCacheDto dco_decode_festival_registry_cache_dto(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return FestivalRegistryCacheDto(
      payloadJson: dco_decode_String(arr[0]),
      fetchedAt: dco_decode_String(arr[1]),
      requestToken: dco_decode_String(arr[2]),
    );
  }
  ...
  GroupCreateResultDto dco_decode_group_create_result_dto(dynamic raw) {
    ...
    return GroupCreateResultDto(
      ...
      festivalId: dco_decode_String(arr[1]),
      invitePayload: dco_decode_String(arr[2]),
    );
  }
  ...
  List<ArtistRelationDto> dco_decode_list_artist_relation_dto(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_artist_relation_dto).toList();
  }
  ...
  MeshtasticDebugReportDto dco_decode_meshtastic_debug_report_dto(dynamic raw) {
    ...
    return MeshtasticDebugReportDto(
      ...
      appliedGroupChats: dco_decode_u_32(arr[7]),
      receivedFrames: dco_decode_list_meshtastic_debug_frame_dto(arr[8]),
      events: dco_decode_list_String(arr[9]),
    );
  }
  ...
  dco_decode_opt_box_autoadd_festival_registry_cache_dto(dynamic raw) {
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_festival_registry_cache_dto(raw);
  }
  ...
  PeerStatusInfo dco_decode_peer_status_info(dynamic raw) {
    ...
    return PeerStatusInfo(
      ...
      status: dco_decode_String(arr[2]),
      bleVisible: dco_decode_bool(arr[3]),
  ...
  ResourceSyncStatusDto dco_decode_resource_sync_status_dto(dynamic raw) {
    ...
    return ResourceSyncStatusDto(
      ...
      peerCount: dco_decode_u_32(arr[6]),
    );
  }
  ...
  TransportPeerDto dco_decode_transport_peer_dto(dynamic raw) {
    ...
    return TransportPeerDto(
      ...
      verifiedEndpoint: dco_decode_opt_String(arr[3]),
      consecutiveFailures: dco_decode_u_32(arr[4]),
      keyPrefix: dco_decode_opt_String(arr[5]),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFestivalRegistryCacheStore(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return FestivalRegistryCacheStoreImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPeerEntry(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return PeerEntryImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerDocManager(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return DocManagerImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerOffbeatNode(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return OffbeatNodeImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  @protected
  RustStreamSink<List<PeerStatusInfo>>
  sse_decode_StreamSink_list_peer_status_info_Sse(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    throw UnimplementedError('Unreachable ()');
  ...
  ArtistProfileDto sse_decode_artist_profile_dto(SseDeserializer deserializer) {
    ...
    var var_mbid = sse_decode_opt_String(deserializer);
    ...
    var var_relations = sse_decode_list_artist_relation_dto(deserializer);
  ...
  ArtistRelationDto sse_decode_artist_relation_dto(
    ...
    return ArtistRelationDto(kind: var_kind, artistId: var_artistId);
  }
  ...
  BleStatusDto sse_decode_ble_status_dto(SseDeserializer deserializer) {
    ...
    var var_advertisingBeacons = sse_decode_list_String(deserializer);
    return BleStatusDto(
      active: var_active,
      ...
      peers: var_peers,
      advertisingBeacons: var_advertisingBeacons,
    );
  }
  ...
  FestivalRegistryCacheDto sse_decode_box_autoadd_festival_registry_cache_dto(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_festival_registry_cache_dto(deserializer));
  }
  ...
  FestivalRegistryCacheDto sse_decode_festival_registry_cache_dto(
    ...
    var var_requestToken = sse_decode_String(deserializer);
    return FestivalRegistryCacheDto(
  ...
  GroupJoinResultDto sse_decode_group_join_result_dto(
    ...
    var var_groupId = sse_decode_String(deserializer);
    var var_festivalId = sse_decode_String(deserializer);
    return GroupJoinResultDto(groupId: var_groupId, festivalId: var_festivalId);
  }
  ...
  List<ArtistRelationDto> sse_decode_list_artist_relation_dto(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ArtistRelationDto>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_artist_relation_dto(deserializer));
    }
    return ans_;
  }
  ...
  MeshtasticDebugReportDto sse_decode_meshtastic_debug_report_dto(
    ...
    var var_appliedGroupChats = sse_decode_u_32(deserializer);
    ...
    return MeshtasticDebugReportDto(
      ...
      appliedGroupChats: var_appliedGroupChats,
  ...
  sse_decode_opt_box_autoadd_festival_registry_cache_dto(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_festival_registry_cache_dto(deserializer));
    } else {
      return null;
    }
  }
  ...
  TransportPeerDto sse_decode_transport_peer_dto(SseDeserializer deserializer) {
    ...
    var var_verifiedEndpoint = sse_decode_opt_String(deserializer);
    var var_consecutiveFailures = sse_decode_u_32(deserializer);
    var var_keyPrefix = sse_decode_opt_String(deserializer);
    return TransportPeerDto(
      deviceId: var_deviceId,
      phase: var_phase,
      connectPath: var_connectPath,
      verifiedEndpoint: var_verifiedEndpoint,
      consecutiveFailures: var_consecutiveFailures,
      keyPrefix: var_keyPrefix,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFestivalRegistryCacheStore(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as FestivalRegistryCacheStoreImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPeerEntry(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as PeerEntryImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerDocManager(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as DocManagerImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFestivalRegistryCacheStore(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as FestivalRegistryCacheStoreImpl).frbInternalSseEncode(
        move: false,
      ),
      serializer,
    );
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerOffbeatNode(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as OffbeatNodeImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSyncStatus(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as SyncStatusImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerDocManager(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as DocManagerImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFestivalRegistryCacheStore(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as FestivalRegistryCacheStoreImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerOffbeatNode(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as OffbeatNodeImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPeerEntry(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as PeerEntryImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  void sse_encode_artist_profile_dto(
    ...
    sse_encode_opt_String(self.mbid, serializer);
    ...
    sse_encode_list_artist_relation_dto(self.relations, serializer);
  ...
  void sse_encode_ble_status_dto(BleStatusDto self, SseSerializer serializer) {
    ...
    sse_encode_list_String(self.advertisingBeacons, serializer);
  }
  ...
  void sse_encode_box_autoadd_festival_registry_cache_dto(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_festival_registry_cache_dto(self, serializer);
  }
  ...
  void sse_encode_festival_registry_cache_dto(
    ...
    sse_encode_String(self.requestToken, serializer);
  }
  ...
  void sse_encode_list_artist_relation_dto(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_artist_relation_dto(item, serializer);
    }
  }
  ...
  void sse_encode_meshtastic_debug_report_dto(
    ...
    sse_encode_u_32(self.appliedGroupChats, serializer);
  ...
  void sse_encode_opt_box_autoadd_festival_registry_cache_dto(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_festival_registry_cache_dto(self, serializer);
    }
  }
  ...
  void sse_encode_peer_status_info(
    ...
    sse_encode_String(self.status, serializer);
    sse_encode_bool(self.bleVisible, serializer);
  ...
  void sse_encode_transport_peer_dto(
    ...
    sse_encode_opt_String(self.verifiedEndpoint, serializer);
    sse_encode_u_32(self.consecutiveFailures, serializer);
    sse_encode_opt_String(self.keyPrefix, serializer);
  }
...
class AppNodeImpl extends RustOpaque implements AppNode {
  ...
  Future<void> connectPeer({required String deviceId}) => RustLib.instance.api
      .crateApiAppNodeConnectPeer(that: this, deviceId: deviceId);
  ...
  Future<void> disconnectRelay() =>
      RustLib.instance.api.crateApiAppNodeDisconnectRelay(that: this);
  ...
  Future<String?> getInvitePayload({
    required String groupId,
    required String festivalId,
  }) => RustLib.instance.api.crateApiAppNodeGetInvitePayload(
    that: this,
    groupId: groupId,
    festivalId: festivalId,
  );
  ...
  Future<int> getPeerCount() =>
      RustLib.instance.api.crateApiAppNodeGetPeerCount(that: this);

  /// Return a snapshot of all known peers for the UI.
  Future<List<PeerStatusInfo>> getPeerList() =>
      RustLib.instance.api.crateApiAppNodeGetPeerList(that: this);
  ...
  Future<void> logoutPreservingPublicData() => RustLib.instance.api
      .crateApiAppNodeLogoutPreservingPublicData(that: this);
  ...
  Future<MeshtasticDebugReportDto> meshtasticListenApplyGroupChats({
    ...
    required String festivalId,
    required int listenMs,
  }) => RustLib.instance.api.crateApiAppNodeMeshtasticListenApplyGroupChats(
    that: this,
    deviceId: deviceId,
    festivalId: festivalId,
    listenMs: listenMs,
  ...
  Future<MeshtasticDebugReportDto> meshtasticSendGroupChat({
    ...
    required String groupId,
    required String text,
  }) => RustLib.instance.api.crateApiAppNodeMeshtasticSendGroupChat(
    that: this,
    deviceId: deviceId,
    groupId: groupId,
    text: text,
  ...
  Future<bool> replaceFestivalRegistryCache({
    ...
    required String fetchedAt,
    required String requestToken,
  }) => RustLib.instance.api.crateApiAppNodeReplaceFestivalRegistryCache(
    that: this,
  ...
  Future<void> restartBle() =>
      RustLib.instance.api.crateApiAppNodeRestartBle(that: this);
  ...
  Future<void> startBleSync() =>
      RustLib.instance.api.crateApiAppNodeStartBleSync(that: this);

  /// Stop the BLE background tasks and wait until their captured state drops.
  Future<void> stopBleSync() =>
      RustLib.instance.api.crateApiAppNodeStopBleSync(that: this);
  ...
  Future<void> subscribeGroups({required String festivalId}) => RustLib
      .instance
      .api
  ...
  Future<String> unlockIdentityFromPrf({required List<int> prfOutput}) =>
      RustLib.instance.api.crateApiAppNodeUnlockIdentityFromPrf(
        that: this,
        prfOutput: prfOutput,
      );
  ...
  Future<Stream<List<PeerStatusInfo>>> watchPeerList() =>
      RustLib.instance.api.crateApiAppNodeWatchPeerList(that: this);
...
@sealed
class DocManagerImpl extends RustOpaque implements DocManager {
  // Not to be used by end users
  DocManagerImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  DocManagerImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_DocManager,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_DocManager,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_DocManagerPtr,
  );
}

@sealed
class FestivalRegistryCacheStoreImpl extends RustOpaque
    implements FestivalRegistryCacheStore {
  // Not to be used by end users
  FestivalRegistryCacheStoreImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  FestivalRegistryCacheStoreImpl.frbInternalSseDecode(
    BigInt ptr,
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_increment_strong_count_FestivalRegistryCacheStore,
    rustArcDecrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_FestivalRegistryCacheStore,
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_FestivalRegistryCacheStorePtr,
  );

  Future<FestivalRegistryCacheDto?> load() =>
      RustLib.instance.api.crateApiFestivalRegistryCacheStoreLoad(that: this);

  Future<bool> replace({
    required String payloadJson,
    required String fetchedAt,
    required String requestToken,
  }) => RustLib.instance.api.crateApiFestivalRegistryCacheStoreReplace(
    that: this,
    payloadJson: payloadJson,
    fetchedAt: fetchedAt,
    requestToken: requestToken,
...
@sealed
class OffbeatNodeImpl extends RustOpaque implements OffbeatNode {
  // Not to be used by end users
  OffbeatNodeImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  OffbeatNodeImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_OffbeatNode,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_OffbeatNode,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_OffbeatNodePtr,
  );
}

@sealed
class PeerEntryImpl extends RustOpaque implements PeerEntry {
  // Not to be used by end users
  PeerEntryImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  PeerEntryImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_PeerEntry,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_PeerEntry,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_PeerEntryPtr,
  );
}
...
class SyncStatusImpl extends RustOpaque implements SyncStatus {
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_SyncStatus,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_SyncStatus,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_SyncStatusPtr,
  );
}
